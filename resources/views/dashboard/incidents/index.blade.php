                    ...
                    <div class="striped-list">
                        ...
                        <div class="row striped-list-item">
                            ...
                            <div class="col-xs-6 text-right">
                                <a href="{{ route('dashboard.incidents.edit', [$incident->id]) }}" class="btn btn-default">{{ trans('forms.edit') }}</a>
                                <a href="{{ route('dashboard.incidents.delete', [$incident->id]) }}" class="btn btn-danger confirm-action" data-method='DELETE'>{{ trans('forms.delete') }}</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
