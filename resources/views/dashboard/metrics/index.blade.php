                ...
                <div class="striped-list">
                    ...
                    <div class="row striped-list-item">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('dashboard.metrics.edit', [$metric->id]) }}" class="btn btn-default">{{ trans('forms.edit') }}</a>
                            <a href="{{ route('dashboard.metrics.delete', [$metric->id]) }}" class="btn btn-danger confirm-action" data-method='DELETE'>{{ trans('forms.delete') }}</a>
                        </div>
                    </div>
                    @empty
