    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form name="UserForm" class="form-vertical" role="form" action="{{ route('dashboard.user') }}" method="POST">
                    {!! csrf_field() !!}
                    <fieldset>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <a href="{{ route('dashboard.user.api.regen', [$current_user->id]) }}" class="input-group-addon btn btn-danger">{{ trans('cachet.api.regenerate') }}</a>
                                    </div>
